...
ConvDown4  = keras.layers.Conv2D(filters=512,kernel_size=(4,4),strides=(2,2),padding="same",activation='relu')(ConvDown3)
ConvDown5  = keras.layers.Conv2D(filters=512,kernel_size=(4,4),strides=(2,2),padding="same",activation='relu')(ConvDown4)
ConvDown6  = keras.layers.Conv2D(filters=512,kernel_size=(4,4),strides=(2,2),padding="same",activation='relu')(ConvDown5)

ConvUp1 = keras.layers.Conv2DTranspose(filters=512,kernel_size=(4,4),strides=(2,2),padding="same",activation='relu')(ConvDown6)
merge1  = keras.layers.concatenate([ConvDown5,ConvUp1],axis=-1)
ConvUp2 = keras.layers.Conv2DTranspose(filters=512,kernel_size=(4,4),strides=(2,2),padding="same",activation='relu')(merge1)
merge2  = keras.layers.concatenate([ConvDown4,ConvUp2],axis=-1)
ConvUp3 = keras.layers.Conv2DTranspose(filters=256,kernel_size=(4,4),strides=(2,2),padding="same",activation='relu')(merge2)
merge3  = keras.layers.concatenate([ConvDown3,ConvUp3],axis=-1)
ConvUp4 = keras.layers.Conv2DTranspose(filters=128,kernel_size=(4,4),strides=(2,2),padding="same",activation='relu')(merge3)
merge4  = keras.layers.concatenate([ConvDown2,ConvUp4],axis=-1)
ConvUp5 = keras.layers.Conv2DTranspose(filters=64,kernel_size=(4,4),strides=(2,2),padding="same",activation='relu')(merge4)
...
history = model.fit(data_inputs,data_targets,epochs=20,batch_size=20,validation_split=0.8,shuffle=True)
