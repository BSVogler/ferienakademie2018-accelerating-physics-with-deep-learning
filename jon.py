...
#    def layerexpand(x):
    ...
    for i in range (0,32):
        ...
        s7=keras.layers.Lambda(cutout1d,arguments={'k':[i*32+24,i*32+17]})(x)
...
#    convEnd = keras.layers.Conv2D(filters=3,activation='relu',kernel_size=3, padding='same',data_format="channels_last", input_shape=(64,64, 3))(concEnd)
#    convEnd2 = keras.layers.Conv2D(filters=3,activation='relu',kernel_size=3, padding='same',data_format="channels_last", input_shape=(64,64, 3))(convEnd)
    convEnd3 = keras.layers.Conv2D(filters=3,kernel_size=3, padding='same',data_format="channels_last", input_shape=(64,64, 3))(concEnd)
